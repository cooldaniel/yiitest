...
define('SS_PARTIAL_DELIVERY',       4); // 部分发货

/* 支付状态 */
define('PS_UNPAYED',                0); // 未付款
define('PS_PAYING',                 1); // 付款中
define('PS_PAYED',                  2); // 已付款
define('PS_PAYFAILURE',             3); // 付款失败
...
define('CS_PAYFAILURE',               103); // 包含 "已确认、付款失败 、未发货" 和 "无效、付款失败 、未发货" 2种情况
...
define('ACT_OWN_AFFILIATE',         3);     // 自主联盟
define('ACT_AWARD',                 4);     // 登陆送积分
...
define('SDT_CONFIRMED',             2); // 订单确认时
define('SDT_PAY',                   3); // 订单付款时
